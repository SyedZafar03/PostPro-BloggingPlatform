         ...
         <Container fluid>
            ...
            <Navbar.Collapse id="navbarScroll">
               <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '100px' }} navbarScroll>
                  {type === 'user' ? (
                     <>
                        <NavLink onClick={() => handleOptionClick('home')} style={{color:"black",textDecoration:"none"}}>Home</NavLink>
                        <NavLink onClick={() => handleOptionClick('postBlog')} style={{color:"black",textDecoration:"none"}}>Post a Blog</NavLink>
                        <NavLink onClick={() => handleOptionClick('myBlogs')} style={{color:"black",textDecoration:"none"}}>My Blogs</NavLink>
                     </>
                  ) : (
                     <>
